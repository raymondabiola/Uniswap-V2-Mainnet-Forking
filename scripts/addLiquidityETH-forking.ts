...
const amountETHMin = ethers.parseEther("3.5");
...
//   await DAI.approve(UNIRouter, amountDAI);
  ...
  console.log("ETHER Balance before adding liquidity:", ethers.formatEther(ethBalBefore));
  ...
  console.log("ETHER Balance after adding liquidity:", ethers.formatEther(ethBalAfter));
  ...
  console.log("ETHER USED:", ethers.formatEther(ethUsed));
};
